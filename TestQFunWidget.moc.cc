...
struct qt_meta_stringdata_TestQFunWidget_t {
    QByteArrayData data[5];
    char stringdata[76];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_TestQFunWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TestQFunWidget_t qt_meta_stringdata_TestQFunWidget = {
    {
...
QT_MOC_LITERAL(4, 56, 19)
    ...
    "TestQFunWidget\0onHNumLineEditEnter\0\0"
    "onVNumLineEditEnter\0onZoomLineEditEnter"
};
...
const QMetaObject TestQFunWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TestQFunWidget.data,
      qt_meta_data_TestQFunWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TestQFunWidget.stringdata))
